...
const int n=4; 			// amount of data to be interpolated
...
int main(){
	...
	double x[n]={0.0,1.0,1.5,2.25},		// data to be interpolated
	y[n] = {2.0000,4.4366,6.7134,13.9130};		// data to be interpolated
