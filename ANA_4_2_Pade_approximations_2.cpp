...
#include <math.h>
using namespace std;
const int n = 5;			// Degree of the numerator
const int m = 5;			// Degree of the denominator
const int N = n+m;
...
int main(){
	...
	b[0] = 1.0;
	double c[N+1] = {0.0,1.0,0.0,-1.0/3.0,0.0,1.0/5.0,0.0,-1.0/7.0,0.0,1.0/9.0,0.0}; // Maclaurin first N+1 coefficients of the series of f(x)
	a[0] = c[0];
