...
#include <math.h>
using namespace std;
const int n = 4;			// Degree of the numerator
const int m = 2;			// Degree of the denominator
const int N = n+m;
...
int main(){
	...
	a[0] = f(0.0);
	b[0] = 1.0;
	double c[N+1] = {1.0,1.0,1.0/2.0,1.0/6.0,1.0/24.0,1.0/120.0,1.0/720.0}; // Maclaurin first N+1 coefficients of the series of f(x)
