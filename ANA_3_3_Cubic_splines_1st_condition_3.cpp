...
const int n=7; 			// amount of data to be interpolated
...
int main(){
	...
	double x[n]={-2.0,-1.0,-0.5,0.0,0.5,1.0,2.0},		// data to be interpolated
	y[n];		// data to be interpolated to function cos^{10}(x)
	for (int i=0 ; i<=n-1 ; i++){
		y[i]=func(x[i]);
	}
