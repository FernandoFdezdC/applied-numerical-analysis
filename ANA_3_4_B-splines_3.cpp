...
const int n=7; 			// number of points-1
...
int main(){
	...
	double x[n+1]={0.0,0.8,1.8,2.0,3.0,4.0,1.5,0.0},		// data to be interpolated
	y[n+1] = {1.0,2.2,2.3,1.2,0.0,0.8,2.0,0.0};		// data to be interpolated
